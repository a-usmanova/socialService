...
public interface PostMapper {
    ...
    @Mapping(target = "isDeleted", constant = "false")
    @Mapping(target = "time", expression = "java(ZonedDateTime.parse(postDto.getPublishDate()))")
//    @Mapping(target = "publishDate", expression = "java(postDto.getPublishDate().equals(\"false\")?ZonedDateTime.now():null)")
